...
/**
 * The Owner agent's LaunchAgent plist. Deliberately a hardcoded constant, not
 ...
 */
export const PIPELINE_LAUNCHD_PLIST_PATH = path.join(
  os.homedir(),
  "Library",
  "LaunchAgents",
  "com.example.email-pipeline.plist"
)
