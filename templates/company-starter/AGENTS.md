...
adapter for one tool. Never make the core depend on the adapter. This file
is the working agreement under the name every agent reads; `CLAUDE.md` is a
pointer to it, not a second source of truth.
