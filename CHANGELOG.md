...
(`Evil <evil@attacker.com> takeshi@plh.life`) is refused rather than resolved
...
## v37 (2026-08-06): fix company-starter's license, retreat branding, and legal exposure
...
end-to-end as an "AI-driven management retreat" program's own starter
...
- **Branding**: removed retreat-program framing from `README.md`,
  `CLAUDE.md`, and ~20 other docs; renamed `ai-retreat-starter` to
  `company-starter` everywhere (titles, directory trees, footers).
- **Deleted retreat-only files** with no place in a software template:
  `exercises/`, `docs/{participant-guide,retreat-day-flow,
  feedback-collection,context-gathering-checklist,
  ai-company-beginner-guide-lp.html}`, and 4 retreat-feedback GitHub
  issue templates.
